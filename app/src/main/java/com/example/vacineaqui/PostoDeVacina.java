...
public class PostoDeVacina {
    ...
    public void setPostoDeVacina(int id, String nome, double latitude, double longitude, boolean disponibilidade, int pacientes, int enfermeiros){
        this.id = id; this.nome = nome; this.latitude = latitude; this.longitude = longitude; this.disponibilidade = disponibilidade;
        this.pacientes = pacientes; this.enfermeiros = enfermeiros;
    }
